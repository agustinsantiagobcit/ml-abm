...
@XmlRootElement(name = "UpdateLegacyConceptMapping")
public class UpdateLegacyConceptMapping {

    @XmlElementRef(name = "legacyConceptMapping", namespace = "http://tempuri.org/", type = JAXBElement.class)
