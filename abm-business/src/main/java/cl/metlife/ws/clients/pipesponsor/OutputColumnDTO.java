...
/**
 * <p>Java class for OutputColumnDTO complex type.
 * 
    ...
    extends Dto
{
    ...
    @XmlElementRef(name = "OutputColumnAlias", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class)
    protected JAXBElement<String> outputColumnAlias;
    @XmlElementRef(name = "OutputColumnDesctiption", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class)
    protected JAXBElement<String> outputColumnDesctiption;
    @XmlElement(name = "OutputColumnId")
    protected Long outputColumnId;
    @XmlElementRef(name = "OutputColumnName", namespace = "http://schemas.datacontract.org/2004/07/SmartGear.MetLife.Srp.Application.MainBoundedContext.DTO", type = JAXBElement.class)
    ...
    /**
     * Gets the value of the outputColumnAlias property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the outputColumnAlias property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    public void setOutputColumnAlias(JAXBElement<String> value) {
        this.outputColumnAlias = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the outputColumnDesctiption property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Sets the value of the outputColumnDesctiption property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    public void setOutputColumnDesctiption(JAXBElement<String> value) {
        this.outputColumnDesctiption = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the outputColumnName property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Sets the value of the outputColumnName property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    public void setOutputColumnName(JAXBElement<String> value) {
        this.outputColumnName = ((JAXBElement<String> ) value);
    }
