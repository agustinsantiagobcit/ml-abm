...
@XmlRootElement(name = "DeleteColumnMapping")
public class DeleteColumnMapping {

    @XmlElementRef(name = "columnMapping", namespace = "http://tempuri.org/", type = JAXBElement.class)
    ...
    public void setColumnMapping(JAXBElement<ColumnMappingDTO> value) {
        this.columnMapping = ((JAXBElement<ColumnMappingDTO> ) value);
    }
