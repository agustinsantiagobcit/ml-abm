...
public class GetAllConnectionResponse {
    ...
    @XmlElementRef(name = "GetAllConnectionResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ArrayOfOutputConnectionDTO> getAllConnectionResult;

    /**
     * Gets the value of the getAllConnectionResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the getAllConnectionResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOutputConnectionDTO }{@code >}
    ...
    public void setGetAllConnectionResult(JAXBElement<ArrayOfOutputConnectionDTO> value) {
        this.getAllConnectionResult = ((JAXBElement<ArrayOfOutputConnectionDTO> ) value);
    }
