...
@XmlRootElement(name = "AddNewStandardConcept")
public class AddNewStandardConcept {

    @XmlElementRef(name = "standardConcept", namespace = "http://tempuri.org/", type = JAXBElement.class)
