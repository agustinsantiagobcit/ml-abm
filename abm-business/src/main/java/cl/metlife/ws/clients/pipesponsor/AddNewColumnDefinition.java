...
@XmlRootElement(name = "AddNewColumnDefinition")
public class AddNewColumnDefinition {

    @XmlElementRef(name = "columnDefinition", namespace = "http://tempuri.org/", type = JAXBElement.class)
