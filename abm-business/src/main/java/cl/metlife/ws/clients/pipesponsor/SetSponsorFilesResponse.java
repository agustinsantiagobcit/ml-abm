...
public class SetSponsorFilesResponse {
    ...
    @XmlElementRef(name = "SetSponsorFilesResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<LogProcessDTO> setSponsorFilesResult;

    /**
     * Gets the value of the setSponsorFilesResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the setSponsorFilesResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link LogProcessDTO }{@code >}
    ...
    public void setSetSponsorFilesResult(JAXBElement<LogProcessDTO> value) {
        this.setSponsorFilesResult = ((JAXBElement<LogProcessDTO> ) value);
    }
