...
@XmlRootElement(name = "UpdateBusinessObjectField")
public class UpdateBusinessObjectField {

    @XmlElementRef(name = "businessObjectField", namespace = "http://tempuri.org/", type = JAXBElement.class)
