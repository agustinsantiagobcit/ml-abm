...
@XmlRootElement(name = "UpdateTargetMappingData")
public class UpdateTargetMappingData {

    @XmlElementRef(name = "targetMappingData", namespace = "http://tempuri.org/", type = JAXBElement.class)
