...
@XmlRootElement(name = "UploadColumnsConfiguration")
public class UploadColumnsConfiguration {

    protected Long fileDefinitionId;
    @XmlElementRef(name = "excelFileBuffer", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<byte[]> excelFileBuffer;
    @XmlElementRef(name = "fileName", namespace = "http://tempuri.org/", type = JAXBElement.class)
    ...
    /**
     * Gets the value of the excelFileBuffer property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the excelFileBuffer property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link byte[]}{@code >}
    ...
    public void setExcelFileBuffer(JAXBElement<byte[]> value) {
        this.excelFileBuffer = ((JAXBElement<byte[]> ) value);
    }
